...
def main():
    # Create webhook handler for Render
    ...
    app.add_handler(CommandHandler("check_my_access", check_my_access))
    ...
    app.add_handler(CommandHandler("setthreads", setthreads))
    app.add_handler(CommandHandler("settime", settime))
    app.add_handler(CommandHandler("setslots", setslots))
    ...
    app.add_handler(CommandHandler("deletekeys", deletekeys))
    app.add_handler(CommandHandler("addreseller", addreseller))
    app.add_handler(CommandHandler("removereseller", removereseller))
    app.add_handler(CommandHandler("resellers", resellers_command))
    app.add_handler(CommandHandler("blockkey", blockkey))
    app.add_handler(CommandHandler("unblockkey", unblockkey))
    ...
    app.add_handler(CommandHandler("blockkey", blockkey_reseller))
    app.add_handler(CommandHandler("unblockkey", unblockkey_reseller))
    app.add_handler(CommandHandler("myblockedkeys", myblockedkeys))
    ...
    ║   BASIC & PREMIUM Plans Available    ║
    ║   Multi-Key Generation Support       ║
    ║   Running on Render                  ║
    ╚══════════════════════════════════════╝
    """)
